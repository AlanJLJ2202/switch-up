            ...
            Column(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextWidget('Figura de coleccion, Bratz. Edicion limitada y con un gran valor para mí',
                      13,
                      FontWeight.w500,
                      Colors.black
                  ),
                ...
                LineaInferior('\$ 900.00 (Precio de compra)', Icons.price_check_outlined, Colors.green, width),
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: TextWidget('#Muñeca, #Otaku, #Anime, #Enfermera', 13, FontWeight.w400, Colors.black)
                            ),
                          ],
                        ),
                      ),
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          LineaInformacion('Practicamente nueva, pues solo se saco del empaque'),
          LineaInformacion('Apto para regalos'),
          LineaInformacion('Se aceptan ofertas de intercambio')
        ],
      ),
    );
  }
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          LineaInformacion('Interambio en punto medio, neni.'),
          LineaInformacion('Se negociarán articulos con un valor aprox de \$ 500.00'),
